...
<script>
	...
	export default {
		...
		mounted() {
			this.menu[2].children[3].hidden = true;
			var user = sessionStorage.getItem('user');
			if (user) {
				user = JSON.parse(user);
				this.sysUserName = user.name || '';
				this.sysUserAvatar = '../static/头像.jpg';
				...
				if(this.permission === 2){
					...
					this.menu[2].children[2].hidden = false;
					this.menu[2].children[3].hidden = true;
				}
				else{
					this.menu[2].hidden = false;
					this.menu[3].hidden = true;
					this.menu[2].children[2].hidden = true;
					this.menu[2].children[3].hidden = false;
				}
			}
